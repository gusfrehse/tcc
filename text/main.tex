...
% título
\title{Análise do Uso de Multiple Importance Sampling em Path Tracing}

% palavras-chave e keywords (p/ resumo, abstract e metadados do PDF)
\pchave{Palavra-chave 1. Computação Gráfica 2. Path Tracing 3. Importance Sampling}
\keyword{Keyword 1. Computer Graphics 2. Path Tracing 3. Importance Sampling}

% autoria
\author{Gustavo Silveira Frehse}
\advisor{André Guedes}
...
\include{3-implem/texto}			% implementacao
\include{4-resultados/texto}		% resultados
