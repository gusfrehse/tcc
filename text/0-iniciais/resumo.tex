\begin{resumo}
  ...
  combina amostragem da BRDF e amostragem direta de fontes de luz, e a
  derivação dos pesos é apresentada de forma explícita para o caminho completo.
  A efetividade da técnica é avaliada por meio da comparação de imagens
  renderizadas com igual número de amostras, com e sem a Amostragem de
  Importância Múltipla. Os resultados demonstram que a técnica reduz
  significativamente a variância do estimador: imagens de variância
