...
triviais\footnote{Por exemplo no caso em que estamos no centro de uma esfera e toda a
superfície dessa esfera é difusa ($f_s$ é constante), em que aí podemos
calcular $L(x \rightarrow x')$ analiticamente, sem entrar na recursão.},
devido à alta dimensionalidade da integral, é necessário utilizar método
mais potentes, como o por exemplo o método de Monte Carlo introduzido em
\cite{metropolis49}.
