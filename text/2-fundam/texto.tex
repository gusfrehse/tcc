...
\begin{itemize}
  \item Materiais com BSDF quase uniforme, ou seja, materiais foscos. Como o
    BSDF é aproximadamente uniforme, o formato de $f$ é dado por $L$.
...
estimador de Monte Carlo, uma por meio da Amostragem por BSDF e outro por meio
...
estratégia por BSDF é pior, e vice-versa.
...
direções, usada na Amostragem por BSDF, para a medida de área, usada na
